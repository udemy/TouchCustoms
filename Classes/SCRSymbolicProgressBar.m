...
@interface SCRSymbolicProgressBar (/* Private methods */)
...
@implementation SCRSymbolicProgressBar
...
- (void)dealloc {
	...
	SCR_RELEASE_SAFELY(_filledImage);
	SCR_RELEASE_SAFELY(_emptyImage);
	
	SCR_RELEASE_SAFELY(_imageViews);
