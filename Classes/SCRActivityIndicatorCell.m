...
#import "SCRActivityIndicatorCell.h"
#import "SCRMemoryManagement.h"

@implementation SCRActivityIndicatorCell
...
- (void)dealloc {
	...
	SCR_RELEASE_SAFELY(_refreshLabel);
	SCR_RELEASE_SAFELY(_activityIndicator);
