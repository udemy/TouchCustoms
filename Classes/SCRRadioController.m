...
@implementation SCRRadioController
...
- (void)dealloc {
	...
	SCR_RELEASE_SAFELY(_optionList);
	SCR_RELEASE_SAFELY(_key);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	SCRRadioCell *cell = (SCRRadioCell *)[tableView dequeueReusableCellWithIdentifier:CellId];
	if (!cell) {
		cell = [[[SCRRadioCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellId] autorelease];
	}
